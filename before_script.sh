...
then
	...
	openssl aes-256-cbc -K $encrypted_a09fc3b71c0b_key -iv $encrypted_a09fc3b71c0b_iv -in ./src/test/resources/wallee_M4M-sandbox.p12.enc -out wallee_M4M-sandbox.p12 -d ;
	# && \
