[![Build Status](https://travis-ci.org/customweb/mdes-sdk.svg?branch=master)](https://travis-ci.org/customweb/mdes-sdk)
...
```groovy
compile "com.customweb:wallee-mdes-sdk:1.1.15"
```
...
* target/wallee-mdes-sdk-1.1.15.jar
* target/lib/*.jar
