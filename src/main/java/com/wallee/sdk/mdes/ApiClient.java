...
public class ApiClient {
	...
	public static class ApiClientConfiguration {
				...
				JSON json)//
		{
			...
			this.publicKeyEncryptionCertificate = Objects.requireNonNull(publicKeyEncryptionCertificate,
					"publicKeyEncryptionCertificate");
			this.consumerKey = Objects.requireNonNull(consumerKey, "consumerKey");
			this.fieldLevelEncryptionConfig = Objects.requireNonNull(fieldLevelEncryptionConfig,
		...
		public static class Builder {
			...
			public ApiClientConfiguration build() {
				return new ApiClientConfiguration(endpoint, signingKey, publicKeyEncryptionCertificate, consumerKey,
						fieldLevelEncryptionConfig, proxy, json);
			}
		}
	}
	...
	private void initialize(ApiClientConfiguration apiClientConfiguration) {
		...
		httpClient.interceptors().add(
				new OkHttp2FieldLevelEncryptionInterceptor(apiClientConfiguration.getFieldLevelEncryptionConfig()));
	...
	/*
	 * private FieldLevelEncryptionConfig
	 * buildFieldLevelEncryptionConfig(Certificate publicKeyEncryptionCertificate,
	 * PrivateKey decryptionPrivateKey) { try { return
	 ...
	 * .withFieldValueEncoding(FieldValueEncoding.HEX) .build(); } catch
	 * (EncryptionException e) { throw new RuntimeException(e); } }
	 */
