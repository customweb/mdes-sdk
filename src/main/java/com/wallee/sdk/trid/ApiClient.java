...
import com.wallee.sdk.trid.auth.ApiKeyAuth;
import com.wallee.sdk.trid.auth.Authentication;
import com.wallee.sdk.trid.auth.HttpBasicAuth;
import com.wallee.sdk.trid.auth.OAuth;
...
public class ApiClient {
    ...
    public enum EndPoint {
        SANDBOX("https://sandbox.api.mastercard.com/customer-id-assignments"),

        MTF("https://api.mastercard.com/customer-id-assignments/mtf"),

        PRODUCTION("https://api.mastercard.com/customer-id-assignments"),
    ...
    public static class ApiClientConfiguration {
        ...
        public static class Builder {
            ...
            public ApiClientConfiguration build() {
                return new ApiClientConfiguration(endpoint, signingKey, consumerKey, json);             
            }
        }
    }
    ...
    private void initialize(ApiClientConfiguration apiClientConfiguration) {
        ...
        // 1) before should run the Encryption interceptor. Omitted. TRID API does not require encryption
    ...
    public ApiClient(ApiClientConfiguration apiClientConfiguration) {
        ...
        if (apiClientConfiguration.getJson() == null) {
            this.json = new JSON();
        } else {
            this.json = apiClientConfiguration.getJson();
        }
    ...
    public String parameterToString(Object param) {
        if (param == null) {
            ...
            return json.formatDatetime((Date) param);
    ...
    public RequestTokenRequestorErrorSchema deserializeError(ApiException exc) {
        Type returnType = new TypeToken<RequestTokenRequestorErrorSchema>(){}.getType();
        String respBody = exc.getResponseBody();
        return json.deserialize(respBody, returnType);
    }
